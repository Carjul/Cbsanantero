    ...
    <div class="container pt-6">
        <div class="row">
            <div class="col-lg-6 position-relative" style="min-height: 500px;">
                <div class="position-absolute h-100 top-0 bottom-0 left-0 right-0 d-flex align-items-center justify-content-center">
                    <img class="w-100 h-100" src="https://img.freepik.com/foto-gratis/impresionado-vistas-pueblo_329181-13895.jpg?t=st=1710033647~exp=1710037247~hmac=c4be828b8d71004a343a14f968684fa7525f7870fb8d0b12f9d121721c35095f&w=900" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="about-text bg-white p-4 p-lg-5 my-lg-5">
                        ...
                        <p>
                            ...
                            Desde la selección de destinos hasta la elección de alojamientos y actividades, estamos comprometidos a brindarte una experiencia que supere tus expectativas.
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="https://img.freepik.com/foto-gratis/piscina_74190-1977.jpg?t=st=1710034750~exp=1710038350~hmac=abc36cb247152aa1e609e9427a1d0b13f7d23bc07308f1229b11de2bba7e15c9&w=900" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="https://img.freepik.com/foto-gratis/piscina_74190-2109.jpg?t=st=1710034774~exp=1710038374~hmac=dde8a6f910141120b6154b404a8cabd7127e35c9ffb8ace7f6ca17b6d77f433b&w=900" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="https://img.freepik.com/foto-gratis/piscina-playa-hotel-lujo-tipo-complejo-entretenimiento-amara-dolce-vita-hotel-lujo-recurso-tekirova-kemer-pavo_146671-18726.jpg?t=st=1710034827~exp=1710038427~hmac=f0c1f5ba02a73c299f6ec4abf2f74f267f5a9ea8940ec36d1b7808c818030600&w=900" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="">
                            <h5 class="text-white">El Tonner</h5>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="https://img.freepik.com/foto-gratis/tipo-complejo-entretenimiento-popular-complejo-piscinas-parques-acuaticos-turquia-hotel-lujo-recurso_146671-18827.jpg?t=st=1710035820~exp=1710039420~hmac=758c1a330afa4df6e036a65708c4252b9b6e2d5b1670c726752740c59ca49bad&w=900" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="">
                            <h5 class="text-white">Condominio</h5>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="https://img.freepik.com/foto-gratis/hermosa-piscina-lujo-al-aire-libre-hotel-resort_74190-7433.jpg?t=st=1710034886~exp=1710038486~hmac=ec17208b54994f9a9ca75cf0f1315a49ea314572bcc4c57ef737aa1c103cc5f9&w=900" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="">
                            <h5 class="text-white">La Playa</h5>
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    ...
                    <p class="text-white">Dedica tus mañanas a relajarte en las hermosas playas de arena blanca. Puedes disfrutar del sol, leer un buen libro o simplemente descansar bajo una sombrilla. Tulum es conocido por sus playas prístinas, así que aprovecha al máximo este paraíso tropical.</p>
                    <ul class="list-inline text-white m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Playas</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Vista al Mar</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Recreaciones</li>
                    </ul>
                </div>
                <div class="col-lg-5">
                    <div style="border-radius: 10%; border-color: blue;" class="card border-0">
                        
                        <img width="100%" height="300px" style="border-radius: 10%;" src="https://img.freepik.com/foto-gratis/pareja-joven-mirando-camara-mientras-esta-sentado-tabla-surf-playa-sol_107420-9962.jpg?t=st=1710038492~exp=1710042092~hmac=d672b94ce166a1fb96a951464128a86c5f2b5ccad2b55f5c077f17a9436a6dc1&w=900" alt="">
        ...
        <div class="container pt-6 pb-3">
            ...
            <div class="row pb-3">
                <div class="col-lg-4 col-md-6 mb-4 pb-2">
                    <div class="blog-item">
                        <div class="position-relative">
                            <img class="img-fluid w-100" src="https://img.freepik.com/foto-gratis/puente-madera-isla-koh-nangyuan-surat-thani-tailandia_335224-1082.jpg?t=st=1710036618~exp=1710040218~hmac=9f4e2032547034e7b05926a75d8815eb349d8822d9e78206e9d9cbdcc7648063&w=900" alt="">
                            <div class="blog-date">
                ...
                <div class="col-lg-4 col-md-6 mb-4 pb-2">
                    <div class="blog-item">
                        <div class="position-relative">
                            <img class="img-fluid w-100" src="https://img.freepik.com/foto-gratis/ocio-asiatico-joven-hermoso-mujer-retrato-relaja-sonrisa-feliz-alrededor-piscina-centro-turistico-hotel_74190-8755.jpg?t=st=1710036726~exp=1710040326~hmac=1dfe9304e527e942a87f3b823d0e21e011118f0059af0ac77e381d2646bc12d6&w=900" alt="">
                            <div class="blog-date">
                                <h6 class="font-weight-bold mb-n1">01</h6>
                                <small class="text-white text-uppercase">Jan</small>
                            </div>
...
/* Animación de pulsación para el botón "Solicitar Servicio" */
@keyframes pulse {
  0% {
    transform: scale(1);
  }
...
/* Aplicar la animación al botón "Solicitar Servicio" */
.btn-book-now {
