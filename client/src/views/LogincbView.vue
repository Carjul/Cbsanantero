            ...
            <div class="card-body">
              ...
              <form @submit.prevent="submitForm">
                ...
                <div>
                    ...
                    <br>
                    <svg style="width:100px;color: brown;" @click="login"  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
